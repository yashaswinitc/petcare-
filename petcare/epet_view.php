...
<b>Search Here: </b><input type="text" id="search-value" name="p_no" placeholder="Enter the pet number" style="width:150px;height:35px;font:bold 15px Times New Roman;" required>&nbsp &nbsp<br>
