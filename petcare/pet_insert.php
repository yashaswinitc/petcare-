...
.bg{
	background:url("images/d10.jpeg")center center no-repeat;
...
<script> function fun2() { window.location="pet_home.html"; } </script></br>
...
header("location: pet_home.html?id=".$p_name);
}
